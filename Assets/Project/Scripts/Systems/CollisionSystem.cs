...
//     private Stash<DeadComponent> deadStash = null!;
...
//             if (a.Type == AnimalType.PREY && b.Type == AnimalType.PREY)
//             {
//                 return;
//             }

//             else if (a.Type == AnimalType.PREDATOR && b.Type == AnimalType.PREY)
//             {
//                 this.deadStash.Add(evt.Other);
//                 this.ShowTasty(evt.Self);
//             }

//             else if (a.Type == AnimalType.PREY && b.Type == AnimalType.PREDATOR)
//             {
//                 this.deadStash.Add(evt.Self);
//                 this.ShowTasty(evt.Other);
//             }

//             else if (a.Type == AnimalType.PREDATOR && b.Type == AnimalType.PREDATOR)
//             {
